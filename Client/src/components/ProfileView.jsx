...
function ProfileView(props) {
    ...
    //LF: Then we would have checks to account for those null or missing values. For example, if workplace is null we could just indicate to the viewing user that the information is hidden due to privacy settings.
    useEffect(() => {
